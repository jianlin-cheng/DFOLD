...
{
	die "The DFOLD databases/tools folder ($DFOLD_db_tools_dir) is not existing\n";
}
...
######### check the DFOLD database and tools
...
{
	die "Failed to find databases and tools under $DFOLD_db_tools_dir/\n";
}

if($DFOLD_db_tools_dir eq "$cur_dir/")
{
	die "Same directory as DFOLD main folder. Differnt path for original databases/tools folder $DFOLD_db_tools_dir is recommended.\n";
}
...
if (prompt_yn("DFOLD will be installed into <$install_dir> ")){

}else{
	die "The installation is cancelled!\n";
}
print "Start install DFOLD into <$install_dir>\n"; 
...
$option_list = "$install_dir/installation/DFOLD_configure_files/DFOLD_scripts_list";
...
$option_list = "$install_dir/installation/DFOLD_configure_files/DFOLD_examples_list";

if (! -f $option_list)
{
        die "\nOption file $option_list not exists.\n";
}
system("rm $install_dir/installation/DFOLD_test_codes/*.sh");
configure_file2($option_list,'installation');
print "#########  Configuring examples, done\n\n\n";

system("chmod +x $install_dir/installation/DFOLD_test_codes/*sh");



system("cp $install_dir/src/run_DFOLD.sh $install_dir/bin/run_DFOLD.sh");
system("chmod +x $install_dir/bin/run_DFOLD.sh");



print "#########  (5) Configuring database update scripts\n";

$option_list = "$install_dir/installation/DFOLD_configure_files/DFOLD_db_list";
...
#installation/DFOLD_programs/.P1_run_hhsearch.sh

print "#########  (7) Configuring DFOLD programs\n";
$method_file = "$install_dir/method.list";
$option_list = "$install_dir/installation/DFOLD_configure_files/DFOLD_programs_list";

`rm $install_dir/installation/DFOLD_programs/*sh`;
...
if(!(-e $method_file) or !(-e $option_list))
{
	...
	@contents = <IN>;
	open(TMP,">$install_dir/installation/DFOLD_configure_files/option.tmp");
	...
	close TMP;
	configure_file2("$install_dir/installation/DFOLD_configure_files/option.tmp",'installation');
	`rm $install_dir/installation/DFOLD_configure_files/option.tmp`;
	`cp $install_dir/installation/DFOLD_programs/*sh $install_dir/bin/`;
...
system("chmod +x $install_dir/src/visualize_DFOLD_cluster/*.sh");
=cut
...
/home/casp13/DFOLD_package/software/prosys_database/cm_lib/chain_stx_info
/home/casp13/DFOLD_package/software/prosys_database/cm_lib/pdb_cm
/home/casp13/DFOLD_package/software/prosys_database/cm_lib/pdb_cm.phr
/home/casp13/DFOLD_package/software/prosys_database/cm_lib/pdb_cm.pin
/home/casp13/DFOLD_package/software/prosys_database/cm_lib/pdb_cm.psq
/home/casp13/DFOLD_package/software/prosys_database/cm_lib/pdb_cm_all_sel.fasta 


/home/casp13/DFOLD_package/software/prosys_database/atom.tar.gz

/home/casp13/DFOLD_package/software/prosys_database/nr_latest/
