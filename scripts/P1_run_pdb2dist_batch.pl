...
foreach $file (@files)
{
	...
	print "perl /data/jh7x3/DFOLD/scripts/pdb2dist_casp.pl  $pdbfile $fasta_dir/$file CB 1 100000  > $work_dir/$pdbname.dist.rr\n";
	`perl /data/jh7x3/DFOLD/scripts/pdb2dist_casp.pl  $pdbfile $fasta_dir/$file CB 1 100000  > $work_dir/$pdbname.dist.rr`;
}
