...
my $program_dssp   = "/home/tianqi/test/DFOLD2/tools/dssp-2.0.4-linux-amd64";
my $cns_suite      = "/home/tianqi/test/DFOLD2/tools/cns_solve_1.3";
my $cns_executable = "$cns_suite/intel-x86_64bit-linux/bin/cns_solve";

# User inputs 
my ($help, $dir_out, $file_fasta, $file_pair, $file_rr, $file_ss);
my ($selectrr, $rrtype, $lambda, $stage2, $contwt, $sswt, $mcount, $rep2, $pthres, $hhbond, $ssnoe, $dihedral,$mcount_dfold);
...
$mcount_dfold = 5 if !$mcount_dfold;
