...
if [[ ! -f "/data/jh7x3/DFOLD/test_out/1BYR-A/stage2/1BYR-A_1.pdb" ]];then 
...
if [[ ! -f "/data/jh7x3/DFOLD/test_out/1BYR-A/stage2/1BYR-A_1.pdb" ]];then 
	...
	printf "\nResults: /data/jh7x3/DFOLD/test_out/1BYR-A/stage2/1BYR-A_1.pdb\n\n"
fi

printf "Validating the results\n\n";
printf "/data/jh7x3/DFOLD/tools/TMscore  /data/jh7x3/DFOLD/test_out/1BYR-A/stage2/1BYR-A_1.pdb  /data/jh7x3/DFOLD/installation/benchmark/native_structure/1BYR-A.pdb\n\n"
/data/jh7x3/DFOLD/tools/TMscore  /data/jh7x3/DFOLD/test_out/1BYR-A/stage2/1BYR-A_1.pdb  /data/jh7x3/DFOLD/installation/benchmark/native_structure/1BYR-A.pdb
