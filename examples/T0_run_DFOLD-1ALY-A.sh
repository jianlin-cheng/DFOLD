...
if [[ ! -f "/data/jh7x3/DFOLD/test_out/1ALY-A/stage2/1ALY-A_1.pdb" ]];then 
...
printf "/data/jh7x3/DFOLD/tools/TMscore  /data/jh7x3/DFOLD/test_out/1ALY-A/stage2/1ALY-A_1.pdb  /data/jh7x3/DFOLD/installation/benchmark/native_structure/1ALY-A.pdb\n\n"
/data/jh7x3/DFOLD/tools/TMscore  /data/jh7x3/DFOLD/test_out/1ALY-A/stage2/1ALY-A_1.pdb  /data/jh7x3/DFOLD/installation/benchmark/native_structure/1ALY-A.pdb
